import { BookOpen, Briefcase, Clock, Code2, Coffee, Folder, Heart, HelpCircle, Home, Layers, LayoutGrid, MapPin, Music, Plus, Settings, Star, Trash2 } from 'lucide-react';
...
export default function Sidebar({ activeNavItem, onNavChange, onFocusTokyoTrip, workspaces, activeWorkspaceId, onCreateWorkspace, onSelectWorkspace, onRenameWorkspace, onSettings, onHelp, onDeleteWorkspace }: SidebarProps) {
