...
export default function HubNode({ data }: NodeProps<HubNodeType>) {
  ...
  return (
    <motion.div
      ...
      style={{ background: `linear-gradient(135deg, ${hub.color} 0%, ${hub.color} 62%, ${hub.shade} 100%)`, boxShadow: '0 7px 16px rgba(32,30,26,0.28), 0 2px 5px rgba(0,0,0,0.18), 0 0 0 2px rgba(255,255,255,0.92), inset 0 1.5px 0 rgba(255,255,255,0.45), inset 0 -2.5px 4px rgba(0,0,0,0.14)' }}
