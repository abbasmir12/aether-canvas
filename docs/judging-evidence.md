...
- Each merged category stream is a three-layer SVG river with a faint glow, colored depth body, white shimmer center, and animated path-sampled flow dots; the hub-to-dashboard trunk increases in visual weight, making the data-synthesis story legible before reading any text.
